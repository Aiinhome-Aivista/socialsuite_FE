...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 overflow-hidden relative font-sans">
      ...
      {/* Navigation */}
      <nav className="relative z-10 max-w-7xl mx-auto px-6 py-6 flex items-center justify-between animate-in fade-in slide-in-from-top-4 duration-500">
      ...
      {/* Hero Section */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-32 text-center animate-in fade-in slide-in-from-bottom-8 duration-700">
